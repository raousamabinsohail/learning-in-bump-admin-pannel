...
class index extends Component {
  ...
  componentDidMount = () => {
    fetch("https://lit-caverns-52628.herokuapp.com/api/admin/viewallvouchers", {
      method: "GET",
      headers: {
  ...
  HandleDelete = (id, index) => {
    ...
    fetch("https://lit-caverns-52628.herokuapp.com/api/admin/deletevoucher", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        authorization: "Bearer " + localStorage.getItem("accessToken"),
                ...
                <Table className="align-items-center table-flush" responsive>
                  ...
                  <tbody>
                    {this.state.data
                      ...
                      .map((value, index) => (
                        <tr key={index}>
                          <th scope="row">{value.brandName}</th>
                          <td>{value.minScore}</td>
                         
                          <td>{value.maxScore}</td>
